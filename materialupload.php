<?php
	...
	require("database/materialuploaddatabase.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<?php
	if($appmaterialflag)
	{
		echo "<script type='text/javascript'> alertBoxInStuUpdate('Material upload successfully'); </script>";
...
<div id="main" class="mainpage">
	...
	<?php require("materialuploadpanel.php"); ?>
