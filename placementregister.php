<?php
	...
	require("database/placementregisterdatabase.php");
...
<div id="main" class="mainpage" style="font-family">

	<!-- Mainpage Navbar -->
	<?php require("navbar.php"); ?>
	
	<!-- Placement Registration Panel -->
	<?php require("placementregisterpanel.php"); ?>
