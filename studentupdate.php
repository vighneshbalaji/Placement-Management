<?php
	...
	require("database/studentupdatedatabase.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<?php
	...
	{
		echo "<script type='text/javascript'> alertBoxInStuUpdate('<strong>Successfully</strong> students record Updated'); </script>";
	}
?>
...
<div id="main" class="mainpage">
	...
	<?php require("studentupdatepanel.php"); ?>
