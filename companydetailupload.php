<?php
	...
	require("database/companydetailuploaddatabase.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
$(document).ready(function(){
	 $('#fileTreeDemo').fileTree({ root: '<?php echo str_replace("\\","/",__DIR__); ?>/companydetails/', script: 'php/jqueryFileTree.php' }, function(file) {
...
<?php
	...
	{
		echo "<script type='text/javascript'> alertBoxInStuUpdate('Company detail upload successfully'); </script>";
...
<div id="main" class="mainpage">
	...
	<?php require("companydetailuploadpanel.php"); ?>
